      ...
      child: Container(
        ...
        child: Row(
          ...
          children: <Widget>[
            ...
            CustomIconButton(icon: CustomIcons.list, text: '歌单'),
            CustomIconButton(icon: CustomIcons.rank, text: '排行榜'),
            CustomIconButton(icon: CustomIcons.radio, text: '电台'),
            CustomIconButton(icon: Icons.panorama_horizontal, text: '直播'),
          ],
        ),
      ),
    );
